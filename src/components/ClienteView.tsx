    ...
    <div className="max-w-5xl mx-auto space-y-12">
      ...
      <div className="space-y-8">
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          className="relative overflow-hidden rounded-[2.5rem] shadow-sm border border-gray-100 bg-white"
        >
          <img 
            src="https://www.webcincodev.com/blog/wp-content/uploads/2026/05/Medios-de-Pagos.png" 
            alt="Medios de Pago" 
